...
class _EncryptCodec extends Codec<Map<String, dynamic>, String> {
  ...
  @override
  Converter<String, Map<String, dynamic>> get decoder => _decoder as _EncryptDecoder;

  @override
  Converter<Map<String, dynamic>, String> get encoder => _encoder as _EncryptEncoder;
}
...
SembastCodec getEncryptSembastCodec({@required String? password}) =>
    SembastCodec(
        ...
        codec: _EncryptCodec(_generateEncryptPassword(password as String)));